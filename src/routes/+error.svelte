...
<article class="page">
	{#if online}
		...
		{:else}
			...
			<p>
				Quelque chose n’a pas fonctionné lorsque nous avons essayé d’afficher cette page. Essayez de
				recharger la page, s’il vous plaît.
			</p>
			<p>
				Si l’erreur persite, faites-nous le savoir en déposant une issue sur une issue sur <a
					href="https://github.com/ouvroir/blog-template/issues">GitHub</a
				>. Merci&nbsp;!
			</p>
		{/if}
